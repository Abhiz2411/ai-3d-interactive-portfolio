...
const About = () => {
  ...
  return (
    <>
      ...
      >
        I'm Abhijit Zende, a Lead AI Engineer working mostly in GenAI and
        Agentic AI. I design, build, and deploy intelligent systems and
        scalable backend infrastructures, with a background spanning
        LangChain, LangGraph, DevOps, and cloud-native applications. I enjoy
        breaking down complex problems, applying data-driven solutions, and
        iterating quickly. Let's work together to bring our ideas to life!
      </motion.p>
      <button
        ref={resumeButtonRef}
        style={magneticStyle}
        ...
        onClick={() =>
          window.open(
            "https://drive.google.com/file/d/1n3sfHJvez82QakDFQLGSWsST8_M_3fLA/view?usp=sharing",
            "_blank",
          )
        }
      >
